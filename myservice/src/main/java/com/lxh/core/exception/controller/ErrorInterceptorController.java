package com.lxh.core.exception.controller;
...
/**
 * 404,500等异常的自定义页面的一种方式，如果要使用请在MyWebAppConfigurer的addInterceptors中使用registry.addInterceptor(new
 * ErrorInterceptorController()).addPathPatterns("/**").excludePathPatterns("/static");
 * 另一种更简单的方式请使用AppErrorPagesConfiguration+ErrorPageController
 * 
 * @author liaoxiaohua
 *
 */
